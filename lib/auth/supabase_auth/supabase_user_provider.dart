...
class GoalsTrackingProjectFromDigitalProSupabaseUser extends BaseAuthUser {
  GoalsTrackingProjectFromDigitalProSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> goalsTrackingProjectFromDigitalProSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = GoalsTrackingProjectFromDigitalProSupabaseUser(
